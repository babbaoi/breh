...
{Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Debug{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Launching Server Stesster Firmware v1.0.0 by 8300.
""")
time.sleep(3)
os.system('cls')
print(f"""
...
{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Debug{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Launching NUKER Firmware v1.0.0 by 8300.                                         
{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Debug{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Machine enviroment check finished. Moving forward     
{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Info{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} 
...
{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Debug{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Launching NUKER Firmware v1.0.0 by 8300.                                         
{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Debug{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Machine enviroment check finished. Moving forward     
{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Info{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Machine uuid:  is now being utilized.     
